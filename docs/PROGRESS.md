...
| 5 | 未使用プリセット×未使用写真の総合検証（2026-09-23 時点: RAW 3 本は平均 ΔE 1.1〜2.3、night 6.1、JPEG 3.2〜6.6） | オーナーが普段使いできると判断 |
| 6 | NIHO Desktop統合 | — |
